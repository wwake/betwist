...
struct ADataBuilder {
  ...
  func convert_multiple_words_to_buffer() {
    ...
    #expect(data[matchEntry: 0] == 0x42000002)    // 'B'
    #expect(data[matchEntry: 1] == 0xC1000005)    // 'A', last match

    #expect(data[matchEntry: 2] == 0xE5000003)    // 'e', last match

    #expect(data[matchEntry: 3] == 0x64000000)    // 'd'
    #expect(data[matchEntry: 4] == 0xF4000000)    // 't', last match

    #expect(data[matchEntry: 5] == 0xF3000000)    // 's', last match
  }
}
